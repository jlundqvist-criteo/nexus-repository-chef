...
public class ChefTestSupport
    extends TestSupport
{
  protected static final String COOKBOOK_LIST = "cookbooklist.json";

  protected static final String COOKBOOK_DETAILS = "cookbookdetails.json";

  protected static final String COOKBOOK_DETAILS_BY_VERSION = "cookbookdetailversion.json";
