...
import org.sonatype.nexus.plugins.chef.internal.ChefFormat
import org.sonatype.nexus.plugins.chef.internal.ChefRecipeSupport
...
import static org.sonatype.nexus.plugins.chef.internal.AssetKind.*
    ...
    LogicMatchers.and(
        ...
        new Matcher() {
          ...
          boolean matches(final Context context) {
            context.attributes.set(AssetKind.class, org.sonatype.nexus.plugins.chef.internal.AssetKind.COOKBOOK)
            return true
          }
        }
    )
